                            ...
                            <div class="article-inner ">
                                <header class="entry-header">
                                    <div class="entry-header-text entry-header-text-top text-left">
                                        ...
                                        <h1 class="entry-title">{{ $item->name_service }}</h1>
                                        <div class="entry-divider is-divider small"></div>

                                        <div class="entry-meta uppercase is-xsmall">
                                            <span class="posted-on">Posted on <a rel="bookmark"><time
                                                        class="entry-date published"
                                                        datetime="2023-09-04T16:10:52+07:00">{{ $item->created_at }}</time></a></span><span
                                ...
                                <div class="entry-content single-page">
                                    ...
                                    <h3><span id="Dich_vu_cua_chung_toi_bao_gom"><strong>Dịch vụ của chúng tôi bao
                                                gồm:</strong></span></h3>
